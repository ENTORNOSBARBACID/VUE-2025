...
<div class="main-nav">
    ...
    <router-link to="/numero">Numeros</router-link>
    <router-link to="/comics">Comics</router-link>
    <router-link to="/seleccion">Select</router-link>
    <router-link to="/checkbox">Checkbox suma</router-link>
    <router-link v-for="n in numeros" :key="n" :to="'/numerodoble/'+n">Numero doble {{ n }}</router-link>
  </div>
</template>
